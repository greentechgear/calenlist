/*
  ...
  1. Creates 6 personas with their calendars
  2. Adds 300 subscribers with random subscriptions
*/
...
AND random() < 0.2; -- This will subscribe each user to about 20% of the calendars
