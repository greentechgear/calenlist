...
-- Create a function to safely get profile display name
CREATE OR REPLACE FUNCTION get_profile_display_name(profile_id uuid)
RETURNS text AS $$
DECLARE
  display_name text;
BEGIN
...
CREATE POLICY "profiles_read"
  ...
  USING (
    ...
    id IN ( -- Profile of a public calendar creator
